...
## Tech Stack
kclhi/jupyter is built on the following main stack:
...
|NAME|VERSION|LAST UPDATED|LAST UPDATED BY|LICENSE|VULNERABILITIES|
|:------|:------|:------|:------|:------|:------|
|[@jupyterlab/application](https://www.npmjs.com/@jupyterlab/application)|v3.0.9|04/23/21|Martin Chapman |BSD-3-Clause|N/A|
|[rimraf](https://www.npmjs.com/rimraf)|v3.0.2|06/11/20|Martin Chapman |ISC|N/A|
